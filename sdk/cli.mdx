...
npx s4kit generate-types --api-key sk_live_abc123 --base-url https://staging.proxy.s4kit.com/api/proxy --output ./types
```
...
S4KIT_BASE_URL=https://staging.proxy.s4kit.com/api/proxy
```
