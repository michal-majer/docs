...
3. Fill in the system details:
   ...
   - **Alias**: A short identifier used in code (e.g., "erp-prod")
...
| Alias | Code identifier | "erp-prod" |
...
const client = new S4Kit({
  apiKey: 'sk_live_...',
  connection: 'erp-prod'  // This is the system alias
});
```
...
|-------------|-------|-------------|
| Production S/4HANA | erp-prod | Live production system |
| Development S/4HANA | erp-dev | Development environment |
| QA S/4HANA | erp-qa | Quality assurance |
| Sandbox | erp-sandbox | Testing and exploration |
