...
<Info>
  Most users interact with S4Kit through the [SDK](/sdk/installation) for SAP operations and the [Dashboard](https://app.s4kit.com) for configuration. The Admin API is for advanced automation use cases.
</Info>
